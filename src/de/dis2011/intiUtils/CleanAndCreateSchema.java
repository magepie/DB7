...
public class CleanAndCreateSchema {
    ...
    public void createSchema(){
        ...
        queries.add("CREATE TABLE PRODUCT (PRODUCT_ID INTEGER NOT NULL, PRODUCT_NAME VARCHAR(40),PRODUCT_FAMILY_ID INTEGER,PRODUCT_FAMILY_NAME VARCHAR(30) NOT NULL,PRODUCT_GROUP_ID INTEGER NOT NULL,PRODUCT_GRPOUP_NAME VARCHAR(30),PRODUCT_CATEGORY_ID INTEGER NOT NULL,PRODUCT_CATEGORY_NAME VARCHAR(30) NOT NULL,PRICE DOUBLE NOT NULL, PRIMARY KEY(PRODUCT_ID))");
        ...
        queries.add("CREATE TABLE SALES (PRODUCT_ID INTEGER NOT NULL, SHOP_ID INTEGER NOT NULL, CITY_ID INTEGER NOT NULL, DATE DATE NOT NULL, NUMBER_ITEMS INTEGER NOT NULL, REVENUE DOUBLE NOT NULL, PRIMARY KEY(PRODUCT_ID, SHOP_ID, CITY_ID, DATE))");
